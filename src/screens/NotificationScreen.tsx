...
const notificationsData: Notification[] = [
  {
    id: '1',
    type: 'health',
    title: 'स्वास्थ्य जांच रिमाइंडर',
    message: 'आपकी वार्षिक स्वास्थ्य जांच का समय हो गया है। कृपया अपनी नियुक्ति बुक करें।',
    time: '2 घंटे पहले',
    date: '16 जुलाई 2025',
    isRead: false,
    priority: 'high',
  ...
  },
  {
    ...
    message: '22 अगस्त को सामुदायिक केंद्र में निःशुल्क स्वास्थ्य शिविर का आयोजन किया जा रहा है।',
    time: '4 घंटे पहले',
    date: '16 जुलाई 2025',
    isRead: false,
    priority: 'medium'
  },
  {
    ...
    type: 'report',
    title: 'रिपोर्ट तैयार',
    message: 'आपकी 10 जुलाई की स्वास्थ्य जांच रिपोर्ट तैयार है और डाउनलोड के लिए उपलब्ध है।',
    time: '1 दिन पहले',
    date: '15 जुलाई 2025',
    isRead: true,
    priority: 'medium'
  },
  {
    id: '4',
    type: 'reminder',
    title: 'दवा का रिमाइंडर',
    message: 'आपकी निर्धारित दवा लेने का समय हो गया है। कृपया अपनी दवा समय पर लें।',
    time: '2 दिन पहले',
    date: '14 जुलाई 2025',
    isRead: true,
    priority: 'high',
  ...
  },
  {
    ...
    type: 'system',
    title: 'ऐप अपडेट',
    message: 'स्वास्थ्य पोर्टल ऐप का नया वर्शन उपलब्ध है। बेहतर सुविधाओं के लिए अपडेट करें।',
    time: '3 दिन पहले',
    date: '13 जुलाई 2025',
    isRead: true,
    priority: 'low'
  },
  {
    id: '6',
    type: 'health',
    title: 'टीकाकरण अनुस्मारक',
    message: 'आपके परिवारिक सदस्य का वार्षिक टीकाकरण बकाया है। कृपया जल्द से जल्द करवाएं।',
    time: '1 सप्ताह पहले',
    date: '9 जुलाई 2025',
    isRead: true,
    priority: 'medium',
